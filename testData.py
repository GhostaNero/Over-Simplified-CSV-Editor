...
def random_email_provider():
    providers = ["gmail.com", "outlook.com", "yahoo.com", "hotmail.com", "icloud.com", "email.com"]
...
second_names = ["Smith", "Johnson", "Williams", "Jones", "Brown", "Davis", "Wilson", "Moore", "Dong", "Xue", "Takahashi", "Lin", "He", "Renji", "Marksman","Togifushi", "Doe"]
